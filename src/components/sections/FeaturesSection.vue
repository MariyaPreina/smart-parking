...
const features = [
  {
    ...
    content: ['Интеграция с городской системой видеонаблюдения',
      ...
      'Прогнозирование освобождения парковочных мест'],
    icon: '🔍'
  },
  {
    id: 2,
    title: 'Контроль запретов парковки',
    content: ['Распознавание дорожных знаков через камеры',
      'Анализ зон и времени действия ограничений',
      'Синхронизация с календарем и геолокацией'],
    icon: '🚫'
  },
  {
    id: 3,
